...
; need to set a label for each data set as energy values are read in
  ds=getrdata(k+1,/ke,wkdir="Data/DataR/paper1/bz0/")
  dt=getrdata(k+1,/ke,wkdir="Data/DataR/paper1/bz05/")
  du=getrdata(k+1,/ke,wkdir="Data/DataR/paper1/bz1/")
...
; on the particle energies is read in. This lower line can be easy to forget about!
  ds=getrdata(k+1,/fields,wkdir="Data/DataR/paper1/bz0/")
  dt=getrdata(k+1,/fields,wkdir="Data/DataR/paper1/bz05/")
  du=getrdata(k+1,/fields,wkdir="Data/DataR/paper1/bz1/")
...
myplot=SCATTERPLOT(xr=[0,xbound*1.05],yr=[0,ybound*1.05],bb1,ee1, SYMBOL='*', $
...
myplot=SCATTERPLOT(bb3,ee3,SYMBOL='*',SYM_COLOR='b',OVERPLOT=1) ;m
